...
cy_stc_ble_gapp_disc_data_t cy_ble_discoveryData[0x01u] = {
    ...
    /* Peripheral configuration 0 */
    {
        { 0x02u, 0x01u, 0x06u, 0x05u, 0x09u, 0x43u, 0x42u,
        0x4Cu, 0x45u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u,
...
static uint8_t cy_ble_attValues[0x24u] = {
    /* Device Name */
    (uint8_t)'C', (uint8_t)'B', (uint8_t)'L', (uint8_t)'E', 
...
static const uint8_t cy_ble_attUuid128[][16u] = {
    /* Device Interface */
    { 0x56u, 0xFBu, 0x4Fu, 0x2Cu, 0xD1u, 0xF5u, 0x26u, 0x8Au, 0xAAu, 0x4Cu, 0x7Du, 0x92u, 0xC0u, 0xC6u, 0x29u, 0xE3u },
    /* Device Outbound */
    { 0x1Fu, 0xE3u, 0x14u, 0x51u, 0x21u, 0x3Bu, 0x34u, 0x97u, 0xB9u, 0x4Du, 0xC5u, 0x49u, 0x69u, 0x48u, 0xDDu, 0x63u },
};
...
static cy_stc_ble_gatts_att_gen_val_len_t cy_ble_attValuesLen[0x0Bu] = {
    ...
    { 0x0010u, (void *)&cy_ble_attUuid128[1] }, /* Device Outbound UUID */
    { 0x0010u, (void *)&cy_ble_attValues[20] }, /* Device Outbound */
...
static const cy_stc_ble_gatts_db_t cy_ble_gattDB[0x13u] = {
    ...
    { 0x0012u, 0x4869u /* Device Outbound                     */, 0x091A0101u /* rd,wr,ntf */, 0x0013u, {{0x0010u, (void *)&cy_ble_attValuesLen[9]}} },
