// ======================================================================
// Accel.v generated from TopDesign.cysch
// 06/08/2026 at 15:30
...
module SCB_I2C_PDL_v2_0_0 (
	...
	cy_clock_v1_0
		#(.id("9421f879-ec0b-4893-b8ea-b19e42ae1d3c/b68e5b9d-7828-482d-a282-930f990e3b3e"),
		  .source_clock_id(""),
		  .divisor(0),
...
module SCB_UART_PDL_v2_0_1 (
	...
	cy_clock_v1_0
		#(.id("9b7d8e98-689d-40da-9353-8fb594dc502d/b68e5b9d-7828-482d-a282-930f990e3b3e"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_mxs40_gpio_v1_0
		#(.id("9b7d8e98-689d-40da-9353-8fb594dc502d/65f3af6c-759b-4ccb-8c66-5c95ba1f5f4f"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("9b7d8e98-689d-40da-9353-8fb594dc502d/b7e8018e-1ef7-49c0-b5a5-61641a03e31c"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("1"),
...
module Scan_ADC_v3_10_4 (
    ...
    electrical [5:0] Net_340;
    electrical [5:0] Net_339;

    cy_mxs40_sarmux_v1_0 SARMUX (
        .cmn_neg(Net_21[0:0]),
        .muxin_minus(Net_340[5:0]),
        .muxin_plus(Net_339[5:0]),
        .muxout_minus(sarmuxOutMinus),
        .muxout_plus(sarmuxOutPlus));
    defparam SARMUX.cmn_neg_width = 1;
    defparam SARMUX.input_mode = "000000";
    defparam SARMUX.muxin_width = 6;


	cy_clock_v1_0
		#(.id("5d39caec-822a-481c-bf5f-62973ed15954/f7143d07-534d-4542-813a-8bb23ceb1ae9"),
...
module top ;
	...
	cy_mxs40_gpio_v1_0
		#(.id("8ea4d500-23dc-43a1-9195-b81a2bb91b2b"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("4"),
		  .ibuf_enabled("1"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("f71ce81b-c08a-4f93-afb0-b647f0f15369"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("e270718e-a154-48e8-8763-f0ba6c2bb412"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("f19d4a02-0e9e-4e1e-98a3-2d5c6d041dbe"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("6dc9ab08-4a48-4c8c-9ca9-4daaf940dfd9"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("fb8ed171-eed7-4b56-8eaa-c09461eceac3"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("4b9c0480-49db-423c-9b93-1772f7d02f8f"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("dc6c6d0f-2a77-4161-9912-3aa66a339115"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("e4ba69ad-02cd-4b62-9990-8961f89f6b32"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
	...
	wire [0:0] tmpFB_0__ONR_LED_net;
	wire [0:0] tmpIO_0__ONR_LED_net;
	electrical [0:0] tmpSIOVREF__ONR_LED_net;

	cy_mxs40_gpio_v1_0
		#(.id("e4b328c7-136e-4f53-9ee3-224533c1dad5"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
		...
		ONR_LED
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__ONR_LED_net[0:0]}),
		  .io({tmpIO_0__ONR_LED_net[0:0]}),
		  .siovref(tmpSIOVREF__ONR_LED_net));
