...
#define CY_BLE_DEVICE_INTERFACE_DEVICE_OUTBOUND_CHAR_INDEX   (0x00u) /* Index of Device Outbound characteristic */
...
#define CY_BLE_DEVICE_INTERFACE_DEVICE_OUTBOUND_DECL_HANDLE   (0x0011u) /* Handle of Device Outbound characteristic declaration */
#define CY_BLE_DEVICE_INTERFACE_DEVICE_OUTBOUND_CHAR_HANDLE   (0x0012u) /* Handle of Device Outbound characteristic */
#define CY_BLE_DEVICE_INTERFACE_DEVICE_OUTBOUND_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0013u) /* Handle of Client Characteristic Configuration descriptor */
